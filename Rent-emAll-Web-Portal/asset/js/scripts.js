...
$(function () {
	...
	$('#itemform').submit(function () {
		...
		if (!city) {
			$('#cityError').text('Please enter the product current city.');
			valid = false;
		}
		if (!postalcode) {
			$('#postal_errors').text('Please enter the product current postal code.');
			valid = false;
		}
		if (!province) {
			$('#provinceError').text('Please enter the product current province.');
			valid = false;
		}
		return valid;
	})
